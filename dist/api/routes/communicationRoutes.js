...
import { createCommunication, getCommunications, getCommunicationById, updateCommunication, deleteCommunication, getThread } from '../controllers/communicationController.js';
const router = Router();
